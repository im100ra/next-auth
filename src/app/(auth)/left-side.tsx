export function LeftSide() {
  return (
    <div className="relative h-screen  hidden w-1/2 items-center justify-center bg-gradient-to-br from-cyan-500 via-sky-600 to-indigo-700 lg:flex overflow-hidden">
